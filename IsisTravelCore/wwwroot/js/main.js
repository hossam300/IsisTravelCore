...
jQuery(window).scroll(function () {
  if (jQuery(window).scrollTop() > 200) {
   ...
   jQuery(".bg-light ").css("background"," linear-gradient(-90deg,rgba(52, 75, 158, 0.73), #4e8226a6)");
...
if (jQuery(window).scrollTop() > 200) {
  jQuery(".navbar-light .navbar-nav .active>.nav-link").css("color","rgb(146, 128, 85)");

jQuery(".navbar-light .navbar-nav .active>.nav-link").addClass("animated-nav");
} else {
jQuery(".navbar-light .navbar-nav .active>.nav-link ").css("color","#faffc6");
jQuery(".navbar-light .navbar-nav .active>.nav-link").removeClass("animated-nav");
};
